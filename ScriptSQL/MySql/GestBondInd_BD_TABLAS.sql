-- ============================================
-- Script de Base de Datos: Gestión de Bodega
-- Versión Portable para MySQL 8.0+
-- ============================================

-- Crear el esquema si no existe
CREATE SCHEMA IF NOT EXISTS TA_PROG3;

-- Usar el esquema
USE TA_PROG3;

-- Configuración temporal para la importación
SET NAMES utf8mb4;
...
-- Tabla: BOD_HISTORIAL_OPERACIONES
...
-- Tabla: BOD_REGISTRO_PAGOS_FIADOS
