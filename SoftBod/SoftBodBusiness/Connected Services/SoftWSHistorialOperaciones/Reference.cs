...
namespace SoftBodBusiness.SoftWSHistorialOperaciones {
    ...
    public partial class listarHistorialOperacionesPorFechaRequest {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://softbodws.services.softbod.pucp.edu.pe/", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public SoftBodBusiness.SoftWSHistorialOperaciones.date fecha;
        
        public listarHistorialOperacionesPorFechaRequest() {
        }
        
        public listarHistorialOperacionesPorFechaRequest(SoftBodBusiness.SoftWSHistorialOperaciones.date fecha) {
            this.fecha = fecha;
        }
    }
    ...
    public partial class listarHistorialOperacionesConFiltrosRequest {
        ...
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public SoftBodBusiness.SoftWSHistorialOperaciones.date fechaOperacion;
        ...
        public listarHistorialOperacionesConFiltrosRequest(int operacionId, string nombreTabla, string tipoOperacion, SoftBodBusiness.SoftWSHistorialOperaciones.date fechaOperacion, int usuarioId, string usuario, string tipoUsuario, bool estado) {
    ...
    public partial class HistorialOperacionesClient : System.ServiceModel.ClientBase<SoftBodBusiness.SoftWSHistorialOperaciones.HistorialOperaciones>, SoftBodBusiness.SoftWSHistorialOperaciones.HistorialOperaciones {
        ...
        public SoftBodBusiness.SoftWSHistorialOperaciones.historialOperacionesDTO[] listarHistorialOperacionesPorFecha(SoftBodBusiness.SoftWSHistorialOperaciones.date fecha) {
        ...
        public System.Threading.Tasks.Task<SoftBodBusiness.SoftWSHistorialOperaciones.listarHistorialOperacionesPorFechaResponse> listarHistorialOperacionesPorFechaAsync(SoftBodBusiness.SoftWSHistorialOperaciones.date fecha) {
            SoftBodBusiness.SoftWSHistorialOperaciones.listarHistorialOperacionesPorFechaRequest inValue = new SoftBodBusiness.SoftWSHistorialOperaciones.listarHistorialOperacionesPorFechaRequest();
            inValue.fecha = fecha;
        ...
        public SoftBodBusiness.SoftWSHistorialOperaciones.historialOperacionesDTO[] listarHistorialOperacionesConFiltros(int operacionId, string nombreTabla, string tipoOperacion, SoftBodBusiness.SoftWSHistorialOperaciones.date fechaOperacion, int usuarioId, string usuario, string tipoUsuario, bool estado) {
