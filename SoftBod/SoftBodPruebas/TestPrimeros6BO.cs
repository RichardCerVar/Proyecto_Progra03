...
using DevolucionDTO = SoftBodBusiness.SoftWSDevolucion.devolucionDTO;
...
using UsuarioDTO = SoftBodBusiness.SoftWSHistorialOperaciones.usuarioDTO;
...
namespace SoftBodPruebas
{
    ...
    public class DevolucionBOTest
    {
        ...
        public void PruebasDevolucion()
        {
            ...
            // 2. Listar por fecha
            Console.WriteLine("2. Listando devoluciones del 2024-11-09...");
            List<DevolucionDTO> devPorFecha = devolucionBO.listarDevolucionesPorFecha("2024-11-09");
            ...
            Console.WriteLine($"4. Listando devoluciones del usuario {usuarioIdPrueba} en fecha 2024-11-09...");
            List<DevolucionDTO> devPorUsuarioFecha = devolucionBO.listarDevolucionesPorUsuarioYFecha(usuarioIdPrueba, "2024-11-09");
    ...
    public class HistorialOperacionesBOTest
    {
        ...
        public void PruebasHistorialOperaciones()
        {
            ...
            List<HistorialOperacionesDTO> histPorTabla = historialBO.listarHistorialOperacionesPorTabla("Producto");
            ...
            // 5. Listar por fecha
            Console.WriteLine("5. Listando operaciones del 2024-11-09...");
            List<HistorialOperacionesDTO> histPorFecha = historialBO.listarHistorialOperacionesPorFecha("2024-11-09");
            Console.WriteLine($"   Total: {histPorFecha.Count}\n");

            // 6. Listar por usuario y tabla
            Console.WriteLine($"6. Listando operaciones del usuario {usuarioIdPrueba} en tabla 'Venta'...");
            List<HistorialOperacionesDTO> histUsuarioTabla = historialBO.listarHistorialOperacionesPorUsuarioYTabla(usuarioIdPrueba, "Venta");
            ...
            List<HistorialOperacionesDTO> histTablaYTipo = historialBO.listarHistorialOperacionesPorTablaYTipoOperacion("Producto", "MODIFICACION");
            ...
            List<HistorialOperacionesDTO> histFiltrado = historialBO.listarHistorialOperacionesConFiltros(
                0, // operacionId (0 = sin filtro)
                "Venta", // nombreTabla
                "", // tipoOperacion (vacío = sin filtro)
                "", // fechaOperacion
                0, // usuarioId (0 = sin filtro)
                "", // usuario
                "", // tipoUsuario
                true // estado
            );
