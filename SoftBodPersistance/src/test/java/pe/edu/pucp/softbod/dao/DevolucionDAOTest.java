...
public class DevolucionDAOTest {
    ...
    public void testInsertar() {
        System.out.println("Insertar-DevolucionDAOTest");
    ...
    public void testObtenerPorId() {
        System.out.println("ObtenerPorId-DevolucionDAOTest");
        ArrayList<Integer> listaDevolucionesId = new ArrayList<>();
        insertarDevoluciones(listaDevolucionesId);
    ...
    public void testListarTodos() {
        System.out.println("ListarTodos-DevolucionDAOTest");
        ArrayList<Integer> listaDevolucionesId= new ArrayList<>();
        insertarDevoluciones(listaDevolucionesId);
    ...
    public void testModificar() {
        System.out.println("Modificar-DevolucionDAOTest");
        ArrayList<Integer> listaDevolucionesId= new ArrayList<>();
        insertarDevoluciones(listaDevolucionesId);
...
//        assertEquals(listaDevolucionesId.size(),listaDevolucion.size());
    ...
    public void testEliminar() {
        System.out.println("Eliminar-DevolucionDAOTest");
        ArrayList<Integer> listaDevolucionesId= new ArrayList<>();
        insertarDevoluciones(listaDevolucionesId);
